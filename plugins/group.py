    ...
    for u in message.new_chat_members:
        ...
        if u.id == temp.ME:
            ...
            if message.chat.id in temp.BANNED_CHATS:
                buttons = [[
                    InlineKeyboardButton('• ᴄᴏɴᴛᴀᴄᴛ ꜱᴜᴘᴘᴏʀᴛ •', url='https://t.me/Union_Botss')
                ]]
            ...
            buttons = [[
                ...
                InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇꜱ', url='https://t.me/Union_Botss')
            ]]
            reply_markup = InlineKeyboardMarkup(buttons)
        ...
        if settings["welcome"]:
            ...
            temp.MELCOW['welcome'] = await message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup([[
                    InlineKeyboardButton('• ᴊᴏɪɴ ᴍʏ ᴜᴘᴅᴀᴛᴇꜱ •', url='https://t.me/Union_Botss')
                ]]),
